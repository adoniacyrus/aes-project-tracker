...
<div id="ticket-workflow-history" data-ajax-container data-ajax-refresh-url="<?php echo e(route('tickets-view', ['id' => $ticket['id'], 'partial' => 'workflow-history'])); ?>">
    <div class="card ticket-sidebar-card ticket-workflow-history-card shadow-sm border border-light mb-3">
        <div class="ticket-sidebar-card__head">
            <i class="ti ti-timeline text-primary"></i>
            <span>Workflow History</span>
        </div>
        <div class="ticket-sidebar-card__body ticket-workflow-history-body">
            ...
            <?php else: ?>
                <div class="ticket-workflow-history-scroll">
