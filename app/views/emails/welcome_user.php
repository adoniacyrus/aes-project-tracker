...
<head>
    ...
    <title>Welcome to AES Project Tracker</title>
</head>
                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="margin:0 0 24px;font-size:15px;line-height:1.6;color:#4b5563;">
                                Your AES Project Tracker account has been created successfully. You can now sign in using the following credentials.
                            </p>
